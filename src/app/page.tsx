  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-indigo-600">MindCompanion</h1>
            </div>
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="#contact" className="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">
                  Contact
                </Link>
              </div>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
              <Link href="#features" className="text-gray-700 hover:text-indigo-600 block px-3 py-2 rounded-md text-base font-medium">
                Features
              </Link>
              ...
              <Link href="/auth" className="bg-indigo-600 text-white block px-3 py-2 rounded-md text-base font-medium hover:bg-indigo-700">
                Get Started
              </Link>
            </div>
          </div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            >
              Your Personal
              <span className="text-indigo-600"> Mental Health</span>
              <br />Companion
            </motion.h1>
            ...
            >
              An intelligent AI therapist that remembers your journey, understands your interests, 
              and provides personalized support for depression, anxiety, loneliness, and more.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              confidential mental health support tailored to your unique needs.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600">
                Engage in meaningful conversations with an AI that understands context, 
                remembers your history, and provides thoughtful responses.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Learn about your hobbies and interests to provide relevant, 
                engaging mental health lessons and coping strategies.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Shared Memory</h3>
              <p className="text-gray-600">
                Choose to share memories across different chat sessions 
                for a more comprehensive understanding of your mental health journey.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Weekly Insights</h3>
              <p className="text-gray-600">
                Receive personalized weekly emails with insights, 
                progress tracking, and gentle reminders for self-care.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Access your mental health companion anytime, anywhere. 
                No appointments needed - support is always available when you need it.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-indigo-100 mb-8 max-w-2xl mx-auto">
            ...
            and growth through their AI mental health companion.
          </p>
          <Link 
            href="/auth" 
            className="bg-white text-indigo-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-50 transition-colors shadow-lg hover:shadow-xl inline-block"
          >
            Get Started Today
          </Link>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-2xl font-bold mb-4">MindCompanion</h3>
            <p className="text-gray-400 mb-4">
              Your intelligent mental health companion for a better tomorrow.
            </p>
            <p className="text-sm text-gray-500">
              © 2024 MindCompanion. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
